...
class ProductTest(TestCase):
    def setUp(self):
        ...
        user = User.objects.create_user(username=self.username, password=self.password) #not used by rest of code
        self.model_instance_name = 'Test Product'
        self.owner = self.return_company()
        self.location = 'Test City'
        self.date = '2022-02-23'
        self.model = Product
        model = self.model.objects.create(name=self.model_instance_name, owner=self.owner) #not used by rest of code 
